...
//                            jiudianEntity.setJiudianKucunNumber(Integer.valueOf(data.get(0)));   //酒店房间 要改的
//                            jiudianEntity.setJiudianNewMoney(data.get(0));                    //金额 要改的
//                            jiudianEntity.setJiudianClicknum(Integer.valueOf(data.get(0)));   //酒店热度 要改的
