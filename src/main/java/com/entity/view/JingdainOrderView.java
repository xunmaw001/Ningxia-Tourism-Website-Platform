...
public class JingdainOrderView extends JingdainOrderEntity implements Serializable {
	...
	*/
	...
	private String jingdainOrderValue;
	...
	public JingdainOrderView() {

	}

	public JingdainOrderView(JingdainOrderEntity jingdainOrderEntity) {
		try {
			BeanUtils.copyProperties(this, jingdainOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getJingdainOrderValue() {
		return jingdainOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setJingdainOrderValue(String jingdainOrderValue) {
		this.jingdainOrderValue = jingdainOrderValue;
	}
	...
	public String toString() {
		return "JingdainOrderView{" +
			", jingdainOrderValue=" + jingdainOrderValue +
