...
public class JingdainCollectionView extends JingdainCollectionEntity implements Serializable {
	...
	*/
	...
	private String jingdainCollectionValue;
	...
	public JingdainCollectionView() {

	}

	public JingdainCollectionView(JingdainCollectionEntity jingdainCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jingdainCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJingdainCollectionValue() {
		return jingdainCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJingdainCollectionValue(String jingdainCollectionValue) {
		this.jingdainCollectionValue = jingdainCollectionValue;
	}
	...
	public String toString() {
		return "JingdainCollectionView{" +
			", jingdainCollectionValue=" + jingdainCollectionValue +
