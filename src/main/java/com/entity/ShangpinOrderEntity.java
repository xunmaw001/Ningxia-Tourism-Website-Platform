...
public class ShangpinOrderEntity<T> implements Serializable {
    ...
    @TableField(value = "shangpin_order_time")

    private Date shangpinOrderTime;
	 ...
	 * 获取：预约时间
	 */
    public Date getShangpinOrderTime() {
        return shangpinOrderTime;
    }
    /**
	 * 设置：预约时间
	 */

    public void setShangpinOrderTime(Date shangpinOrderTime) {
        this.shangpinOrderTime = shangpinOrderTime;
    }
    /**
	 * 获取：实付价格
	 */
    ...
    public String toString() {
        return "ShangpinOrder{" +
            ...
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", shangpinOrderTime=" + DateUtil.convertString(shangpinOrderTime,"yyyy-MM-dd") +
