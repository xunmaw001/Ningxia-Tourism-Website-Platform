...
public class JingdainCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JingdainCommentbackEntity() {

	}

	public JingdainCommentbackEntity(T t) {
		try {
    ...
    @TableField(value = "jingdain_commentback_text")
    ...
    public String toString() {
        return "JingdainCommentback{" +
            ", id=" + id +
            ", jingdainId=" + jingdainId +
            ", yonghuId=" + yonghuId +
            ", jingdainCommentbackText=" + jingdainCommentbackText +
