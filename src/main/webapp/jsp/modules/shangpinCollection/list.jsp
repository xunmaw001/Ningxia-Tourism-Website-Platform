        ...
        <div class="modal-dialog" style="z-index: 3000">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitShangpinCollection()" class="btn btn-info">评价</button>
                </div>
            </div>
        </div>
    </div>
...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="shangpinCollectionExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/shangpinCollectionMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('shangpin_collection_types')">类型<i id="shangpinCollectionTypesIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function upload() {
            /*导入数据*/
            $('#shangpinCollectionExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("shangpinCollection/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("shangpinCollection/update", "POST", {
                    id:id,
