                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 shangpinCollectionTypesDiv">
                                        <label>类型</label>
                                        <select style="width: 450px" id="shangpinCollectionTypesSelect" name="shangpinCollectionTypes" class="form-control"></select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationShangpinCollectionTypesSelect(){
            ...
            if(shangpinCollectionTypesSelect != null && shangpinCollectionTypesOptions != null  && shangpinCollectionTypesOptions.length > 0 ){
                shangpinCollectionTypesSelect.options.length=0;
    ...
    function getDetails() {
        ...
        if (addshangpinCollection != null && addshangpinCollection != "" && addshangpinCollection != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='shangpinCollection'){
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="shangpinCollection"){//个人中心修改
            }
        }
