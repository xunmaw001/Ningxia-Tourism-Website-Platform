...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">路线留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">路线留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">路线留言列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="luxianLiuyanExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/luxianLiuyanMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('luxian_liuyan_text')">留言内容<i id="luxianLiuyanTextIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function getDataList() {
            http("luxianLiuyan/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                luxianLiuyanDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //留言内容
            var luxianLiuyanTextCell = document.createElement('td');
            luxianLiuyanTextCell.innerHTML = item.luxianLiuyanText;
            row.appendChild(luxianLiuyanTextCell);
        ...
        function upload() {
            /*导入数据*/
            $('#luxianLiuyanExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("luxianLiuyan/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("luxianLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("luxianLiuyan/update", "POST", {
                    id:id,
                    luxianLiuyanTypes:2
                }, (res) => {
                    if(res.code == 0){
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addluxianLiuyan", "addluxianLiuyan");
            window.location.href = "add-or-update.jsp"
        }
