                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiudianOrderUuidNumber" name="jiudianOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.jiudianOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>预约时间</label>
                                        <input style="width: 450px" id="jiudianOrderTime" name="jiudianOrderTime" class="form-control"
                                               v-model="ruleForm.jiudianOrderTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiudianOrderTruePrice" name="jiudianOrderTruePrice" class="form-control"
                                               v-model="ruleForm.jiudianOrderTruePrice" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="jiudianOrderValue" name="jiudianOrderValue" class="form-control"
                                           v-model="ruleForm.jiudianOrderValue" readonly>
                                </div>
