...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="jingdainCommentbackExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/jingdainCommentbackMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('jingdain_commentback_text')">评价内容<i id="jingdainCommentbackTextIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('insert_time')">评价时间<i id="insertTimeIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        var tableName = "jingdainCommentback";
        var pageType = "list";
        var searchForm = {key: ""};
        var pageIndex = 1;
        var pageSize = 10;
        ...
        function getDataList() {
            http("jingdainCommentback/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                jingdainCommentbackDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //评价内容
            var jingdainCommentbackTextCell = document.createElement('td');
            jingdainCommentbackTextCell.innerHTML = item.jingdainCommentbackText;
            row.appendChild(jingdainCommentbackTextCell);
        ...
        function upload() {
            /*导入数据*/
            $('#jingdainCommentbackExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("jingdainCommentback/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jingdainCommentback/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("jingdainCommentback/update", "POST", {
                    id:id,
                    jingdainCommentbackTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjingdainCommentback", "addjingdainCommentback");
            window.location.href = "add-or-update.jsp"
        }
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'jingdainCommentback.xlsx'
            });
            excel.generate();
        }
...
// 101 102 103 104 105
            ...
            function chartDialog(){
                ...
                //    groupColumn: "jingdain_commentback_types",
                //    // riqi:echartsDate
                //}, (res) => {//pieSum pieCount
                //    if (res && res.code === 0) {
                //        let data = res.data;
