...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="luxianCollectionExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/luxianCollectionMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>路线名称<i id="luxianNameIcon"></i></th>
                                        <th>路线照片<i id="luxianPhotoIcon"></i></th>
                                        <th>路线类型<i id="luxianTypesIcon"></i></th>
                                        <th>用户姓名<i id="yonghuNameIcon"></i></th>
                                        <th onclick="sort('luxian_collection_types')">类型<i id="luxianCollectionTypesIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var luxianCollectionTypesCell = document.createElement('td');
            luxianCollectionTypesCell.innerHTML = item.luxianCollectionValue;
            row.appendChild(luxianCollectionTypesCell);
        ...
        function upload() {
            /*导入数据*/
            $('#luxianCollectionExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("luxianCollection/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("luxianCollection/update", "POST", {
                    id:id,
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'luxianCollection.xlsx'
            });
            excel.generate();
        }
