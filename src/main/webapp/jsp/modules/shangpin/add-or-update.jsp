                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangjia">
                                        <label>商家名称</label>
                                        <input style="width: 450px" id="shangjiaName" name="shangjiaName" placeholder="商家名称" class="form-control" readonly>
                                    </div>
                            <!-- 当前表的字段 -->
                                ...
                                <input id="shangjiaId" name="shangjiaId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 shangpinAddressDiv">
                                        <label>商品地点</label>
                                        <input style="width: 450px" id="shangpinAddress" name="shangpinAddress" class="form-control"
                                               placeholder="商品地点">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 shangpinTypesDiv">
                                        <label>商品类型</label>
                                        <select style="width: 450px" id="shangpinTypesSelect" name="shangpinTypes" class="form-control"></select>
                                    </div>
                                    <div class="form-group col-md-6 shangpinKucunNumberDiv">
                                        ...
                                        <input style="width: 450px" id="shangpinKucunNumber" name="shangpinKucunNumber" class="form-control"
                                               onchange="integerChickValue(this)"  placeholder="商品库存">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        $('#shangpinPhotoupload').fileupload({
            ...
            dataType: 'json',
                ...
                document.getElementById('shangpinPhotoImg').setAttribute('src',baseUrl+photoUrl);
            ...
            if(window.sessionStorage.getItem('role') != '商家'){//当前登录用户不为这个
                if($("#shangjiaId") !=null){
                    ...
                    if(shangjiaId == null || shangjiaId =='' || shangjiaId == 'null'){
                        layui.layer.msg("商家不能为空", {time: 2000,icon: 5});
                        return;
                    }
                }
            }
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationShangpinTypesSelect(){
            ...
            if(shangpinTypesSelect != null && shangpinTypesOptions != null  && shangpinTypesOptions.length > 0 ){
                shangpinTypesSelect.options.length=0;
    ...
    function getContent() {
        ...
        if($("#shangpinContentupload").length>0) {
            ...
            if (shangpinContentEditor.hasContents()) {
                $('#shangpinContent-input').attr('value', shangpinContentEditor.getContent().replaceAll(baseUrl,""));
            }
        }
    }
    function jiaofei() {
    ...
    function getDetails() {
        ...
        if (addshangpin != null && addshangpin != "" && addshangpin != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='shangpin'){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangpinAddress").val(ruleForm.shangpinAddress);
    ...
    function showImg() {
        <!--  当前表的图片  -->
        $("#shangpinPhotoImg").attr("src",baseUrl+ruleForm.shangpinPhoto);
    ...
    function shangjiaShowImg() {
        $("#shangjiaPhotoImg").attr("src",baseUrl+ruleForm.shangjiaPhoto);
    }
    ...
    function shangjiaShowVideo() {
        $("#shangjiaPhotoV").attr("src",baseUrl+ruleForm.shangjiaPhoto);
    }
    ...
    function readonly() {
        $('#shangpinUuidNumber').attr('readonly', 'readonly');
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="shangpin"){//个人中心修改
            }
        }
