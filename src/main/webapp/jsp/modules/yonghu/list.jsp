                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>用户编号</label>
                                        <input type="text" id="yonghuUuidNumberSearch" placeholder="请输入用户编号" aria-controls="tableId" class="form-control form-control-sm">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('yonghu_uuid_number')">用户编号<i id="yonghuUuidNumberIcon" class="fa fa-sort"></i></th>
                                        ...
                                        <th onclick="sort('new_money')">余额<i id="newMoneyIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_email')">用户邮箱<i id="yonghuEmailIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
