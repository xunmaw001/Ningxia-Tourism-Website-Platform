...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="shangpinCommentbackExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/shangpinCommentbackMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('shangpin_commentback_text')">评价内容<i id="shangpinCommentbackTextIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function upload() {
            /*导入数据*/
            $('#shangpinCommentbackExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("shangpinCommentback/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("shangpinCommentback/update", "POST", {
                    id:id,
                    shangpinCommentbackTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
