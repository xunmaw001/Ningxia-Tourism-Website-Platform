                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangjiaXingjiTypesDiv">
                                        <label>商家信用类型</label>
                                        <select style="width: 450px" id="shangjiaXingjiTypesSelect" name="shangjiaXingjiTypes" class="form-control"></select>
                                    </div>
                                    <div class="form-group col-md-6 newMoneyDiv">
                                        <label>现有余额</label>
                                        <input style="width: 450px" id="newMoney" name="newMoney" class="form-control"
                                               onchange="doubleChickValue(this)" placeholder="现有余额">
                                    </div>
<!--                                        <button onclick="jiaofei()" type="button" class="btn">我要缴费</button>-->
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationShangjiaXingjiTypesSelect(){
            ...
            if(shangjiaXingjiTypesSelect != null && shangjiaXingjiTypesOptions != null  && shangjiaXingjiTypesOptions.length > 0 ){
                shangjiaXingjiTypesSelect.options.length=0;
    ...
    function getContent() {
        ...
        if($("#shangjiaContentupload").length>0) {
            ...
            if (shangjiaContentEditor.hasContents()) {
                $('#shangjiaContent-input').attr('value', shangjiaContentEditor.getContent().replaceAll(baseUrl,""));
            }
        }
    }
    function jiaofei() {
    ...
    function getDetails() {
        ...
        if (addshangjia != null && addshangjia != "" && addshangjia != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='shangjia'){
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="shangjia"){//个人中心修改
            }
        }
