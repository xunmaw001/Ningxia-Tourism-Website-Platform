...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="shangjiaExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/shangjiaMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('shangjia_name')">商家名称<i id="shangjiaNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('shangjia_phone')">联系方式<i id="shangjiaPhoneIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('shangjia_email')">邮箱<i id="shangjiaEmailIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('shangjia_photo')">营业执照展示<i id="shangjiaPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('shangjia_xingji_types')">商家信用类型<i id="shangjiaXingjiTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('new_money')">现有余额<i id="newMoneyIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            var shangjiaPhotoImgValue = baseUrl+item.shangjiaPhoto;
        ...
        function upload() {
            /*导入数据*/
            $('#shangjiaExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("shangjia/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
