...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">酒店评价管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">酒店评价管理</li>
                            <li class="breadcrumb-item active">酒店评价列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">酒店评价列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="jiudianCommentbackExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/jiudianCommentbackMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('jiudian_commentback_text')">评价内容<i id="jiudianCommentbackTextIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        var tableName = "jiudianCommentback";
        var pageType = "list";
        var searchForm = {key: ""};
        var pageIndex = 1;
        var pageSize = 10;
        ...
        function getDataList() {
            http("jiudianCommentback/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                jiudianCommentbackDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //评价内容
            var jiudianCommentbackTextCell = document.createElement('td');
            jiudianCommentbackTextCell.innerHTML = item.jiudianCommentbackText;
            row.appendChild(jiudianCommentbackTextCell);
        ...
        function upload() {
            /*导入数据*/
            $('#jiudianCommentbackExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("jiudianCommentback/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiudianCommentback/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("jiudianCommentback/update", "POST", {
                    id:id,
                    jiudianCommentbackTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiudianCommentback", "addjiudianCommentback");
            window.location.href = "add-or-update.jsp"
        }
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'jiudianCommentback.xlsx'
            });
            excel.generate();
        }
