            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">景点订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jingdainOrderUuidNumber" name="jingdainOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.jingdainOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>预约时间</label>
                                        <input style="width: 450px" id="jingdainOrderTime" name="jingdainOrderTime" class="form-control"
                                               v-model="ruleForm.jingdainOrderTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jingdainOrderTruePrice" name="jingdainOrderTruePrice" class="form-control"
                                               v-model="ruleForm.jingdainOrderTruePrice" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="jingdainOrderValue" name="jingdainOrderValue" class="form-control"
                                           v-model="ruleForm.jingdainOrderValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jingdainOrder/info/" + id,
