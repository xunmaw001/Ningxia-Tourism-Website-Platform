...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									...
									<label>用户名</label>
									<input type="text" id="usernameSearch" placeholder="用户名" aria-controls="tableId" class="form-control form-control-sm">

									<button onclick="search()" type="button" class="btn btn-primary">查询</button>
									<button onclick="add()" type="button" class="btn btn-primary">添加</button>
									<button onclick="deleteMore()" type="button" class="btn btn-danger">批量删除</button>
								</div>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			addtimeCell.innerHTML = date.toLocaleString();
		...
		//添加
		function add(){
            window.sessionStorage.setItem("addUser", "addUser");
			window.location.href = "add-or-update.jsp"
		}
