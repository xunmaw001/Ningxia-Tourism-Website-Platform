        ...
        <div class="modal-dialog" style="z-index: 3000">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitJiudianCollection()" class="btn btn-info">评价</button>
                </div>
            </div>
        </div>
    </div>
...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="jiudianCollectionExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/jiudianCollectionMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('jiudian_collection_types')">类型<i id="jiudianCollectionTypesIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var jiudianCollectionTypesCell = document.createElement('td');
            jiudianCollectionTypesCell.innerHTML = item.jiudianCollectionValue;
            row.appendChild(jiudianCollectionTypesCell);
        ...
        function upload() {
            /*导入数据*/
            $('#jiudianCollectionExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("jiudianCollection/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("jiudianCollection/update", "POST", {
                    id:id,
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'jiudianCollection.xlsx'
            });
            excel.generate();
        }
