                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>类型</label>
                                    <input style="width: 450px" id="jingdainCollectionValue" name="jingdainCollectionValue" class="form-control"
                                           v-model="ruleForm.jingdainCollectionValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jingdainCollection/info/" + id,
