                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpin">
                                        <label>商品名称</label>
                                        <input style="width: 450px" id="shangpinName" name="shangpinName" placeholder="商品名称" class="form-control" readonly>
                                    </div>
                                    <div class="form-group col-md-6 shangpin">
                                        <label>商品照片</label>
                                    ...
                                    <div class="form-group col-md-6 shangpin">
                                        <label>商品类型</label>
                                        <input style="width: 450px" id="shangpinValue" name="shangpinValue" placeholder="商品类型" class="form-control" readonly>
                                    </div>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 shangpinOrderTimeDiv">
                                        <label>预约时间</label>
                                        <input style="width: 450px" id="shangpinOrderTime-input" name="shangpinOrderTime" type="text" class="form-control layui-input">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 shangpinOrderTypesDiv">
                                        <label>订单类型</label>
                                        <select style="width: 450px" id="shangpinOrderTypesSelect" name="shangpinOrderTypes" class="form-control"></select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationShangpinOrderTypesSelect(){
            ...
            if(shangpinOrderTypesSelect != null && shangpinOrderTypesOptions != null  && shangpinOrderTypesOptions.length > 0 ){
                shangpinOrderTypesSelect.options.length=0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuId: "required",
                buyNumber: "required",
                shangpinOrderTime: "required",
                shangpinOrderTruePrice: "required",
                shangpinOrderTypes: "required",
            },
            messages: {
                shangpinOrderUuidNumber: "订单编号不能为空",
                shangpinId: "商品不能为空",
                yonghuId: "用户不能为空",
                buyNumber: "购买数量不能为空",
                shangpinOrderTime: "预约时间不能为空",
    ...
    function getDetails() {
        ...
        if (addshangpinOrder != null && addshangpinOrder != "" && addshangpinOrder != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='shangpinOrder'){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangpinOrderTime-input").val(ruleForm.shangpinOrderTime);
    ...
    function shangpinShowVideo() {
        $("#shangpinPhotoV").attr("src",baseUrl+ruleForm.shangpinPhoto);
    }
    ...
    function readonly() {
        $('#shangpinOrderUuidNumber').attr('readonly', 'readonly');
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="shangpinOrder"){//个人中心修改
            }
        }
        ...
        var shangpinOrderTime = laydate.render({
            elem: '#shangpinOrderTime-input'
            ,type: 'datetime'
        });
