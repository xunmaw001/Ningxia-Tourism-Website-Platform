            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">酒店推荐登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiudianUuidNumber" name="jiudianUuidNumber" class="form-control"
                                               v-model="ruleForm.jiudianUuidNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiudianAddress" name="jiudianAddress" class="form-control"
                                               v-model="ruleForm.jiudianAddress" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>酒店类型</label>
                                    <input style="width: 450px" id="jiudianValue" name="jiudianValue" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiudianKucunNumber" name="jiudianKucunNumber" class="form-control"
                                               v-model="ruleForm.jiudianKucunNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>酒店热度</label>
                                        <input style="width: 450px" id="jiudianClicknum" name="jiudianClicknum" class="form-control"
                                               v-model="ruleForm.jiudianClicknum" readonly>
                                    </div>
