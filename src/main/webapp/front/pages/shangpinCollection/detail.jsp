        ...
        <div style="width: 50%;height: auto;">
            <div class="particulars" style="text-align: center;font-size: 18px;">
                <span>{{title}}</span>
                  ...
                  <div v-if="detail.shangpinCollectionTypes" class="particulars">
                      <span class="displayBianhao">类型:</span>
                      <span class="dataExhibition"> {{detail.shangpinCollectionValue}} </span>
                  </div>
        </div>
        <!-- 图片 -->
        <div style="width: 50%;height: auto;">
    ...
    <script>
        ...
        var vue = new Vue({
            ...
            methods: {
                //分享
                share(){
                    let element = createElement("http://localhost:8080/ningxialvyouwangzhan/front/index.jsp?url="+"./pages/shangpinCollection/detail.jsp?id="+this.id);
                    element.select();
        ...
        layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'util'], function () {
            ...
            localStorage.setItem("goUtl","./pages/shangpinCollection/detail.jsp?id="+ http.getParam('id'))
