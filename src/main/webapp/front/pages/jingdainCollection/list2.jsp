...
//                    jingdainCollectionTypes:1,
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery', 'laydate', 'tinymce'], function() {
        ...
        localStorage.setItem("goUtl","./pages/jingdainCollection/list2.jsp")
        ...
        $(document).on("click", ".thisTableType-search", function (e) {
           ...
           function jingdainCollectionTypesSelect() {
               http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jingdain_collection_types", 'get', {}, function (res) {
                   if(res.code == 0){
