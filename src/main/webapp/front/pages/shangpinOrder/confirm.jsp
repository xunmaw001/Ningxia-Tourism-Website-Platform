            ...
            <table class="layui-table" lay-skin="nob" style="border: 3px dotted #EEEEEE;margin: 20px 0;">
                ...
                <tr v-for="(item,index) in dataList" v-bind:key="index">
                    <td style="display: flex;text-align: left;">
                        <img :src="baseUrl+item.shangpinPhoto" style="width: 100px;height: 100px;object-fit: cover;">
                    ...
                    <td style="width: 100px;">{{(item.shangpinNewMoney*item.buyNumber).toFixed(2)}} RMB</td>
                </tr>
                </tbody>
            </table>
		...
		<script>
            var vue = new Vue({
                ...
                methods: {
                    ...
                    ,payClick() {
                    let data={
                        buyNumber:JSON.parse(localStorage.getItem('shangpins'))[0].buyNumber,
                        shangpinId:JSON.parse(localStorage.getItem('shangpins'))[0].shangpinId,
                        shangpins:localStorage.getItem('shangpins'),
			            yonghuId: localStorage.getItem('userid'),
                            shangpinOrderTime:getDatetimeFormat(vue.shangpinOrderTime),//年月日时分秒
                    }
                        // 获取商品详情信息
                        layui.http.requestJson(`shangpinOrder/add`, 'POST', data, (res) => {
                            if(res.code == 0){
