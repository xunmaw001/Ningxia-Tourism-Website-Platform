        ...
        <div class="left-container"
            ...
            <ul class="layui-nav layui-nav-tree">
                <li v-for="(item,index) in centerMenu" v-bind:key="index" class="layui-nav-item"
                    :class="item.url=='../shangpinOrder/list.jsp'?'layui-this':''">
        ...
        <div class="right-container sub_borderColor"
            ...
            <div style="display: flex;height: 60px;align-items: center;margin-left: 15px;">
                <div style="display: flex;height: 60px;align-items: center;margin-left: 15px;">
                    ...
                    <div style="margin-left: 15px;" v-for="item in shangpinOrderTypesList" :index="item.codeIndex"
            ...
            <div style="width: 90%;margin: 0 auto;border: 1px solid #f3f3f3;margin-top: 15px;"
                ...
                <div
                    ...
                    <div style="margin-left: 50px;"
                         v-if="item.shangpinOrderTypes != 101 && item.shangpinOrderTypes != 102 && item.shangpinOrderCourierName != null">
                ...
                <div style="display: flex;">
                    ...
                    <div style="width: 10%;margin: 15px;">
                        <button v-if="item.shangpinOrderTypes==101" @click="refund(item.id)" type="button"
                                class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
                            <i class="layui-icon">&#xe65e;</i> 退款
                        </button>
                        <button v-if="item.shangpinOrderTypes==1 && false" @click="wuyong(item.id)" type="button"
                                class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
                            无用按钮
                        </button>
                    </div>
