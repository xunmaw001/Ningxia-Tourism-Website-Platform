        ...
        <div style="width: 50%;height: auto;">
            <div class="particulars" style="text-align: center;font-size: 18px;">
                <span>{{title}}</span>
                  ...
                  <div v-if="detail.shangjiaXingjiTypes" class="particulars">
                      <span class="displayBianhao">商家信用类型:</span>
                      <span class="dataExhibition"> {{detail.shangjiaXingjiValue}} </span>
                  </div>
            <div style="color: red" class="particulars" @click="jump('../shangpin/list.jsp?shangjiaId='+detail.id)">
                <span class="displayBianhao">当前商家下商品:</span>
    ...
    <script>
        ...
        var vue = new Vue({
            ...
            methods: {
                //分享
                share(){
                    let element = createElement("http://localhost:8080/ningxialvyouwangzhan/front/index.jsp?url="+"./pages/shangjia/detail.jsp?id="+this.id);
                    element.select();
        ...
        layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'util'], function () {
            ...
            localStorage.setItem("goUtl","./pages/shangjia/detail.jsp?id="+ http.getParam('id'))
            ...
            http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
                ...
                vue.detail.shangjiaContent = vue.detail.shangjiaContent.replaceAll("src=\"upload/","src=\""+vue.baseUrl+"upload/");
                // 轮播图片
