...
var centerMenu = [
    ...
    ,{
        name: '景点收藏',
        url: '../jingdainCollection/list.jsp'
    }
    ,{
        name: '景点订单',
        url: '../jingdainOrder/list.jsp'
    }
    ,{
        name: '酒店收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/ningxialvyouwangzhan/admin/dist/index.jsp#/login";
